...
const Home1 = ({ setActive, user, active }) => {
  ...
  //   // const trendQuery = query(blogRef, where("trending", "==", "no"));
      ...
      <div className="container padding">
        <div className="row mx-0">
          ...
          <div className="col-md-8">
            <div className="blog1-heading1 text-start py-2 mb-4"> Welcome ADMIN :)</div>
            {blogs.length === 0 && location.pathname !== "/admin" && (
              <>
                <h4>
